  ...
  return (
    <section className='max-w-7xl mx-auto'>
      <div>
        ...
        <p className='mt-2 text-[#666e75] text-[16px] max-w-[500px]'>Create collection of imaginative and stunning images generated by DALL-E AI</p>
      </div>
      <form className='mt-16 max-w-3xl' onSubmit={handleSubmit} action="">
        ...
        <div className='mt-5 flex gap-5'>
          <button type='button' onClick={generateImage} className='text-white bg-blue-500 font-medium rounded-md text-sm w-full sm:w-auto px-5 py-2.5 text-center'>
        ...
        <div className='mt-10 '>
              ...
              <button type='submit' className='mt-3 text-white bg-blue-500 font-medium rounded-md text-sm w-full sm:w-auto px-5 py-2.5 text-center'>
